...
var result = string .replace(/black|dog|car/gi, function myFunction(x){return x.toUpperCase();}); 
console.log(result)     // Mrs BLACK has a BLACK DOG and a BLACK CAR
var string = "Mrs Black has a black dog and a black car";
var result = string .replace(/black|dog|car/gi, (x) => x.toUpperCase()); 
console.log(result)  // Mrs BLACK has a BLACK DOG and a BLACK CAR
var string = "15.03.2025, 16:03:38";
var result = string .replace(/20|,/gi, () => ""); 
console.log(result)